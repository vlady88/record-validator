...
public class CSVParserTest {
    ...
    private static final String GOOD_INPUT_FILE = "src/test/resources/records.csv";
    private static final String BAD_INPUT_FILE = "src/test/resources/records.json";
    private static final String NON_EXISTENT_INPUT_FILE = "src/test/resources/records";

    @Test
    public void testValidInput() {
        RecordParser parser = new CSVParser();
