...
<div id="content">
	<div class="sect1">
		<h2 id="_input">Failed records</h2>
		<div class="sectionbody">
			<table class="tableblock frame-all grid-all spread">
				...
				<tr>
					...
					<th class="tableblock halign-left valign-top">Start Balance</th>
					<th class="tableblock halign-left valign-top">Mutation</th>
					<th class="tableblock halign-left valign-top">End Balance</th>
					<th class="tableblock halign-left valign-top">Fail Reason</th>
				</tr>
				</thead>
				<tbody>
                <#list failedRecords as record >
					<tr>
						<td class="tableblock halign-left valign-top"><p class="tableblock">${record.reference}</p></td>
						<td class="tableblock halign-left valign-top"><p class="tableblock">${record.iban}</p></td>
						<td class="tableblock halign-left valign-top"><p class="tableblock">${record.description}</p></td>
						<td class="tableblock halign-left valign-top"><p class="tableblock">${record.startBalance}</p></td>
						<td class="tableblock halign-left valign-top"><p class="tableblock">${record.mutation}</p></td>
						<td class="tableblock halign-left valign-top"><p class="tableblock">${record.endBalance}</p></td>
						<td class="tableblock halign-left valign-top"><p class="tableblock">${record.status}</p></td>
					</tr>
                </#list>
				</tbody>
			</table>
